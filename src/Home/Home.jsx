        ...
        <div className="intro-card">
          <section className="about-section">
            <p>
              ...
              <br />
              כבר שלוש שנים אני עובד כ<strong>מפתח Full Stack</strong> בבית
              התוכנה <strong>GoNet</strong> – תפקיד שאני באמת נהנה ממנו. אני
              אוהב ליצור, ללמוד ולהפוך רעיון לקוד שעובד.
            </p>

            <p>
              תמיד הייתי מחובר לעולם המחשבים. עוד מגיל צעיר הייתי גיימר, וזה
              פיתח בי את הרצון להשתפר כל הזמן ולעשות כל דבר בצורה הטובה ביותר.
            </p>
